...
const commit = '291453e2a957fb83dedb0c209ed2cdd14ba90c0e';
...
if (!process.argv[2] || !process.argv[3]) throw new Error('Supply pinned Builder and Context Package schemas.');
...
const code = standaloneCode(ajv, { validateSource: id + '#/$defs/source', validateNormalized: id + '#/$defs/normalized' });
await writeFile(process.argv[4] ?? new URL('../src/context-builder/generated/source-v1.js', import.meta.url),
  `// Generated from Codex ${commit}; unreleased development candidate.\n// Schema SHA-256: ${pins.join(', ')}\n// Rebuild with scripts/generate-builder-source-validator.mjs; do not edit.\nimport { createRequire } from 'node:module';\nconst require = createRequire(import.meta.url);\n` + code);
